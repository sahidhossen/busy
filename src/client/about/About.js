    ...
    return (
      <div>
        ...
        <div className="container faq-container">
          ...
          <p>
            {`Steemitalia è la prima piattaforma di blogging italiana basata su blockchain Steem. Il
            progetto nasce dall’esigenza di creare uno strumento su misura in grado di soddisfare
            tutte le esigenze della crescente comunità italiana su Steem. Con una piattaforma
            graficamente accattivante e un utilizzo intuitivo, Steemitalia si propone come una
            valida alternativa tutta italiana a Steemit e Busy, attualmente i frontend più avanzati
            su blockchain Steem di cui tecnicamente Steemitalia è un fork.`}
          </p>
          <h3 className="sub-title"> {'L’ecosistema Steem'} </h3>
          <p>
            {' '}
            {`L’idea di fondo della blockchain Steem è realizzare un ecosistema efficace per la creazione di community che stimolino le interazioni social, attraverso un sistema premiale basato sulla criptovaluta Steem. Steem combina concetti presi dal mondo del blogging, dei social media e delle community online, oltre che dal campo delle criptovalute e della community che le circonda. In qualsiasi tipo di community online e offline, un concetto chiave per incentivare le persone a partecipare è un equo sistema di retribuzione/riconoscimento del lavoro svolto, che rifletta in modo giusto il contributo che il singolo dà alla community. Steem è la prima criptovaluta che prova a retribuire in modo accurato e trasparente un illimitato numero di persone che attraverso i propri contenuti personali e originali partecipano allo sviluppo della community. Creata sulla base di programmi open source e di una blockchain pubblicamente accessibile per permettere la costruzione di community e le interazioni tra utenti grazie ai pagamenti in cryptovaluta, Steem permette di creare applicazioni e servizi che accedono direttamente alla blockchain. La piattaforma Steem è creata usando Graphene, la stessa tecnologia che alimenta Bitshares (un altro network basato su blockchain creato da Dan Larimer, il co-fondatore di Steem e Steemit insieme a Ned Scott). `}
          </p>
          ...
          <br />
          <p>
            {`Per completare l’iscrizione a Steem tramite il sito Steemit sono necessari diversi
            giorni di attesa, ma ci sono altri modi per creare un account:`}
          </p>
          <ul>
          ...
          <p>
            La Reputazione Utente ha fondamentalmente due funzioni.
            <br />
            Indica quanto un utente è "fidato o apprezzato dalla comunità".
            <br />
            Impedisce agli utenti con scarsa reputazione di danneggiare gli altri utenti.
            <br />
          ...
          <ul type="number">
            <li> STEEM </li>
            <li> STEEM DOLLARS </li>
            <li> STEEM POWER: il potere di voto che ogni utente guadagna sulla piattaforma</li>
          </ul>
          ...
          <p>
            Gli STEEM DOLLARS sono la moneta principale dell'ecosistema Steem. <br />
            ...
            <br />
            Nota bene: Le ricompense dei post su Steemit sono quantificate in STEEM DOLLAR.
            <br />
            Anche gli STEEM DOLLARS possono essere scambiati sia sul mercato interno o sui vari
            exchange come blocktrades, bittrex, ecc.
          </p>
          ...
          <p>
            ...
            producono tramite i voti che ricevono ai loro post. Più il post sarà apprezzato dagli
            utenti, più voti riceverà e più guadagnerà. Questo perché a differenza degli altri
            social network, il voto che un utente dà ad un altro ha valore. Votare un post
          </p>
          <p>
          ...
          <p>
            ...
            **SteemPower** (il potere di voto che ogni utente guadagna sulla piattaforma), la
            reputazione, l’andamento del mercato delle crypto, ecc. Commentare un post
          </p>
          <p>
          ...
          <p>
            <a
              href={`https://steemit.com/ita/@thenightflier/ricompense-calcolo-manuale-ed-automatizzato `}
              rel="noopener noreferrer"
              target="_blank"
            >
              https://steemit.com/ita/@thenightflier/ricompense-calcolo-manuale-ed-automatizzato{' '}
            </a>
          </p>
          <p>
            Il valore accumulato da un post nell’arco dei 7 giorni necessari per poter riscuotere il
            ricavato, corrisponde a una cifra ben precisa di STEEM, SBD e STEEM POWER. Le ricompense
            effettive dei post che pubblicate, si calcolano moltiplicando l'ammontare che vedete
            sotto il vostro post per ~75% e dividendo per 2. La cifra ottenuta sarà la quantità di
            SBD che incasserete, invece dividendo la stessa per il cambio attuale di Steem contro
            USD (dollari americani) otterrete la quantità di SP (Steem Power) che incasserete.
          </p>
          ...
          <p>
            ...
            dal post nell’apposita sezione del profilo utente. Reinvestire nel sistema
          </p>
          <p>
          ...
          <p>
            [@steempostitalia è tante cose](
            <a
              href={`https://steemit.com/ita/@steempostitalia/steempostitalia`}
              rel="noopener noreferrer"
              target="_blank"
            >
              https://steemit.com/ita/@steempostitalia/steempostitalia
            </a>
            ): @Steempostitalia è uno **spazio virtuale di incontro** per gli utenti italiani
            iscritti sulla piattaforma Steemit.
          </p>
          <p>
            È un **hub di idee e progetti** (come ad esempio **@spi-postit**, la rubrica quotidiana
            deimigliori contenuti della community), che cerca nella tecnologia della blockchain un
            motore di innovazione e propositività.
          </p>
          <p>
          ...
          <p>
            ...
            scaricare l'app e usarla da mobile come fate con Telegram. Per unirsi al gruppo, basta
            seguire questo link: discordapp.com/invite/QDKPzSp{' '}
          </p>
          ...
          <p>
            Più in generale, verranno supportati i contest che necessitano di una certa applicazione
            di tempo e di impegno da parte dei partecipanti.
          </p>
          <br />
          <p>
          ...
          <p>
            ...
            decisamente più strutturata. Oltre al nome del proponente e al titolo della proposta
            progettuale, viene richiesto di identificare principalmente:
          </p>
          <p> - l'ambito in cui si colloca il progetto;</p>
          <p>
            {' '}
          ...
          <p>
            ...
            richiesta di sostegno economico, alla ricerca di collaboratori, alla pubblicizzazione);
          </p>
          <p>
            {' '}
            - il tipo di competenze richieste per costruire un eventuale team di collaboratori;
          </p>
          <p> - una previsione di tempistica e di fasi del progetto;</p>
          <p> - l'identificazione di eventuali costi (e di chi li sosterrà);</p>
          <p> - la previsione dei benefici (economici o altro) derivanti dalla realizzazione.</p>
        </div>
        <Footer />
      </div>
    );
