              ...
              <div className="Settings">
                ...
                <div className="Settings__section">
                  ...
                  <p>
                    <FormattedMessage
                      id="language_info"
                      defaultMessage="What language do you want to use on Steem Italia?"
                    />
                  </p>
                  <Select
                ...
                <div className="Settings__section">
                  ...
                  <p>
                    <FormattedMessage
                      ...
                      defaultMessage="You can enable this option to replace Steemit.com links with Steem Italia links."
                    />
                  </p>
                  <div className="Settings__section__checkbox">
                    <Checkbox
                ...
                <div className="Settings__section">
                  <h3>
                    <FormattedMessage id="use_beta" defaultMessage="Use Steem Italia beta" />
                  </h3>
                  <p>
                    <FormattedMessage
                      id="use_beta_details"
                      defaultMessage="You can enable this option to use Steem Italia beta by default."
                    />
                  </p>
                  <div className="Settings__section__checkbox">
